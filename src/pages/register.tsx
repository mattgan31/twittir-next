      ...
      <div className="flex flex-col box-content w-80 border rounded-lg p-6">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="p-2">
            ...
            <Link href={'/login'}>
              <button className="flex w-full justify-center text-indigo-600 px-3 py-1.5 my-2 rounded-md bg-indigo-100 hover:bg-indigo-300 hover:text-white">Login</button>
            </Link>
          </div>
        </form>
      </div>
